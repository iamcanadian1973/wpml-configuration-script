(function (document, window, $) {
    ...
    .before( '<div class="wpml-section wpml-section-tcf-translation" id="ml-content-setup-sec-generate-xml"><div class="wpml-section-header"><h3>Generate XML</h3><p>Make sure system fields are set to "show" and that all custom fileds are set to "display all results"</p></div><div class="wpml-section-content wpml-section-content-wide"><p><button id="generate-xml-button" class="button-primary">Generate XML</button></p></div></div>' );  
